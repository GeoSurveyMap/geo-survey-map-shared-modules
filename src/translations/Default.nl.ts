export const nl = {
	...
	categoryInformationTooltip: {
		DRY_SOILS: '<b>Verwoestijning</b> - Het proces waarbij relatief droge grond steeds droger wordt.',
		WET_SOILS: '<b>Beoordeling van waterverzadiging van de bodem</b> - Waterverzadiging treedt op wanneer overtollig water de bodem verzadigt.',
		EROSION: '<b>Bodemerosie</b> - Erosie is het proces waarbij land of bodem wordt verwijderd door een of meerdere processen.',
		SEALED_SOILS:
			'<b>Bodemafdichting</b> - Het proces waarbij de bodem wordt afgedekt door gebouwen of kunstmatige materialen, die vaak weinig tot geen water doorlaten.',
		DEGRADATION:
			'<b>Bodemverarming</b> - Een negatief proces dat vaak wordt versneld door menselijke activiteiten (onjuist bodemgebruik, landbouwpraktijken, bodemafdichting).',
		LOSS_OF_ORGANIC_MATTER:
			'<b>Verlies van organische stof in de bodem</b> - Afname van het organische stofgehalte in een of meerdere bodemlagen.',
		PH: '<b>Verzuring</b> - Het proces waarbij de concentratie waterstofionen in de bodem geleidelijk toeneemt.',
		BIODIVERSITY: '<b>Biodiversiteit</b> - De variabiliteit van levende organismen uit alle bronnen.'
	},
	pointStatus: {
		status: 'Status',
		PENDING: 'In afwachting van verificatie',
	...
	userProfile: {
		...
		deleteAccountPopup: {
			...
			firstConfirmation: {
				...
				description: 'Weet je zeker dat je je account wilt verwijderen? Al je gegevens zullen verloren gaan en kunnen niet worden hersteld.'
			},
			secondConfirmation: {
	...
	pointManagement: {
		...
		pointsToApprove: 'Te beoordelen punten',
		approvedPoints: 'Goedgekeurde punten',
		pointId: 'Punt-ID',
		pointName: 'Puntnaam',
	...
	userManagement: {
		...
		confirmDeleteMessage: 'Weet je zeker dat je dit gebruikersaccount en alle bijbehorende invoeren wilt verwijderen?',
		cancel: 'Annuleren',
		confirm: 'Account verwijderen',
		noUsers: 'Geen gebruikers om weer te geven'
	},
	onboarding: {
