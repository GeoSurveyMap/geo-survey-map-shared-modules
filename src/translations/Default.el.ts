export const el = {
	...
	togetherWeMap:
		'Μαζί χαρτογραφούμε, συνδέουμε και εκπαιδεύουμε για να καλλιεργήσουμε γνώση για το έδαφος, προάγοντας την ευαισθητοποίηση, τη συμμετοχή και τις βιώσιμες πρακτικές.',
