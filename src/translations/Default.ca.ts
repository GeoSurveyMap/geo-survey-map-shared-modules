export const ca = {
	...
	categoryInformationTooltip: {
		...
		DEGRADATION:
			'<b>Degradació del sòl</b> - Procés negatiu sovint accelerat per activitats humanes (ús inadequat del sòl i pràctiques de cultiu, impermeabilització del sòl).',
	...
	togetherWeMap:
		'Junts, mapegem, connectem i eduquem per fomentar el coneixement del sòl, augmentant la consciència, el compromís i les pràctiques sostenibles.',
	...
	mappingSoilDegradationDescription1:
		'LOESS Soil Map és una plataforma que uneix la comunitat en l’esforç per protegir els sòls. Mitjançant mapes interactius i eines de geolocalització, els usuaris poden construir conjuntament una base de dades afegint informació sobre les condicions del sòl a les seves àrees locals.',
