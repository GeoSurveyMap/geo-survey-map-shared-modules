...
export const ga = {
	...
	categoryInformationTooltip: {
		...
		DEGRADATION:
			'<b>Meath ithreach</b> - Próiseas diúltach a dhéantar níos measa go minic mar gheall ar ghníomhaíochtaí daonna (úsáid mhícheart ithreach agus cleachtais talmhaíochta, séalaíocht ithreach).',
	...
	userProfile: {
		...
		deleteAccountPopup: {
			...
			firstConfirmation: {
				...
				description:
					'An bhfuil tú cinnte gur mian leat do chuntas a bhaint? Caillfear do shonraí go léir agus ní bheidh tú in ann iad a chur ar ais.'
			},
			secondConfirmation: {
	...
	onboarding: {
		...
		instruction: {
			...
			step2: {
				...
				description:
					'Cuir isteach gach eolas a bhailigh tú ar mhaithe le cáilíocht na tuairisce, a chabhróidh le taighdeoirí an fhadhb a réiteach.'
			},
			step3: {
	...
	togetherWeMap:
		'Le chéile, mapálaimid, nascann muid, agus múinimid chun litearthacht ithreach a chothú, ag cur feasachta, rannpháirtíochta agus cleachtais inbhuanaithe chun cinn.',
