export const hu = {
	...
	categoryInformationTooltip: {
		...
		SEALED_SOILS:
			'<b>Talajlezárás</b> - A talaj beépítése épületekkel vagy mesterséges anyagokkal, amelyek lassan vagy egyáltalán nem engedik át a vizet.',
		DEGRADATION:
			'<b>Talajdegradáció</b> - Egy negatív folyamat, amelyet gyakran emberi tevékenységek gyorsítanak fel (helytelen talajhasználat, mezőgazdasági gyakorlatok, talajlezárás).',
		...
		BIODIVERSITY:
			'<b>Biodiverzitás</b> - Az élő szervezetek változatossága minden forrásból, beleértve a szárazföldi, tengeri és egyéb vízi ökoszisztémákat.'
	},
	pointStatus: {
		status: 'Állapot',
