export const fr = {
	...
	togetherWeMap:
		'Ensemble, nous cartographions, connectons et éduquons pour cultiver la connaissance des sols, en favorisant la sensibilisation, l’engagement et les pratiques durables.',
	...
	mappingSoilDegradationDescription1:
		'LOESS Soil Map est une plateforme qui rassemble la communauté dans l’effort de protéger les sols. En utilisant des cartes interactives et des outils de géolocalisation, les utilisateurs peuvent construire collectivement une base de données en ajoutant des informations sur les conditions des sols dans leurs zones locales.',
