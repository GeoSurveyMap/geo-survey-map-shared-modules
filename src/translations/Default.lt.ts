  ...
  onboarding: {
    ...
    instruction: {
      ...
      step1: {
        ...
        description:
          'Galite naudoti mūsų pateiktus pavyzdžius, kad nustatytumėte, su kokio tipo dirvožemiu susiduriate.',
      },
      step2: {
      ...
      step3: {
        ...
        description:
          'Siekiant išvengti žalingo turinio, kiekvienas pranešimas turės būti patvirtintas mūsų komandos.',
      },
    },
    aboutSoils: {
