...
exports.useDeleteUserSelf = exports.useBanOrReactivateUser = exports.useSetUserPermissions = exports.useGetUsersWithinCountry = exports.useGetSelfUserData = exports.useGetAllUsers = exports.useRegisterUser = void 0;
...
function useGetSelfUserData() {
    return (0, react_query_1.useQuery)({
        queryKey: query_1.queryKeys.users.self,
        queryFn: function () { return (0, user_1.getSelfUserData)(); },
        select: function (_a) {
            var data = _a.data;
            return data.data;
        },
...
exports.useGetSelfUserData = useGetSelfUserData;
