...
export declare function useDeleteUser(): import("@tanstack/react-query").UseMutationResult<import("axios").AxiosResponse<import("./user.types").GetUsersResponse, any>, Error, import("./user.types").UpdateUserPermissionsRequest, unknown>;
