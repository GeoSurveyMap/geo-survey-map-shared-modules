...
export declare function useGetUsersWithinCountry(permissions: Permissions): import("@tanstack/react-query").UseQueryResult<import("./user.types").GetUsersWithinCountryResponse, Error>;
