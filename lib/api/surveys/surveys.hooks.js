...
exports.useDownloadSurveysReport = exports.useUpdateSurveyStatus = exports.useGetUsersSurveys = exports.useGetSurveysWithinBoundingBox = exports.useGetAllSurveys = exports.useGetAllSurveysWithinRadius = exports.useGetSurveyByLocation = exports.useFileUpload = exports.useCreateSurvey = void 0;
...
function useDownloadSurveysReport() {
    return (0, react_query_1.useMutation)({
        mutationFn: surveys_1.downloadSurveysReport,
        onError: function () {
            console.error('Error downloading report');
        },
    });
}
exports.useDownloadSurveysReport = useDownloadSurveysReport;
