...
exports.getSurveysReport = exports.updateSurveyStatus = exports.getUsersSurveys = exports.getSurveysWithinBoundingBox = exports.getAllSurveys = exports.getAllSurveysWithinRadius = exports.getSurveyByLocation = exports.postUploadFile = exports.createSurvey = void 0;
...
function getSurveysReport() {
    return axiosClient_1.axiosClient.put(URLS.SURVEY_REPORT);
}
exports.getSurveysReport = getSurveysReport;
