...
exports.downloadSurveysReport = exports.updateSurveyStatus = exports.getUsersSurveys = exports.getSurveysWithinBoundingBox = exports.getAllSurveys = exports.getAllSurveysWithinRadius = exports.getSurveyByLocation = exports.postUploadFile = exports.createSurvey = void 0;
...
function downloadSurveysReport(params) {
    return axiosClient_1.axiosClient.get(URLS.SURVEY_REPORT, {
        params: params,
        responseType: 'blob',
        headers: {
...
exports.downloadSurveysReport = downloadSurveysReport;
