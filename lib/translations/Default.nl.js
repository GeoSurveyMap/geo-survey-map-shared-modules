...
exports.nl = {
    ...
    onboarding: {
        ...
        aboutSoils: {
            title: 'Over bodems',
            description: 'Klik op de bodemcategorie waarover u informatie wilt bekijken. Deze optie is ook beschikbaar in de sectie Instellingen van de applicatie.'
        }
    },
    problemCause: {
    ...
    togetherWeMap: 'Samen kaarten we, verbinden we en onderwijzen we om bodemkennis te bevorderen, bewustzijn, betrokkenheid en duurzame praktijken te stimuleren.',
