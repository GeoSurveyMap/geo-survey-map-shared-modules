...
exports.en = {
    ...
    pointDetails: {
        ...
        problemSolution: 'Potential problem cause',
    ...
    onboarding: {
        ...
        instruction: {
            ...
            step2: {
                ...
                description: 'Include all the information that you gathered for the quality of the report, that will help the researchers trying to solve the problem.'
            },
            step3: {
    ...
    mappingSoilDegradationDescription1: 'LOESS Soil Map is a platform that brings the community together in the effort to protect soils. By leveraging interactive maps and geolocation tools, users can collaboratively build a database by adding information about soil conditions in their local areas.',
    mappingSoilDegradationDescription2: 'The collected data supports researchers and decision-makers in making informed environmental decisions. With a straightforward survey form and an intuitive interface, anyone can contribute to a deeper understanding of soil degradation processes and effectively help protect soils.',
    sharedKnowledgeBase: 'A Shared Knowledge Base for a Better Tomorrow',
    sharedKnowledgeBaseDescription1: 'The LOESS Soil Map project, carried out under the international LOESS research program, aggregates data on soil erosion, pH, and moisture, enabling global analysis. As a result, users gain access to comprehensive information they can put into practice—ranging from scientific research to ecological initiatives.',
    sharedKnowledgeBaseDescription2: 'Establishing a cohesive data ecosystem is our key to collective solutions. Through community involvement and modern technologies, LOESS Soil Map becomes a central hub for information exchange, supporting environmental protection efforts and safeguarding the interests of future generations.',
