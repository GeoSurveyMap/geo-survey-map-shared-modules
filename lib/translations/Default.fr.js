...
exports.fr = {
    ...
    problemCause: {
        lackOfRainfall: 'Manque de précipitations',
        highTemperatures: 'Températures élevées',
        poorSoilStructure: 'Structure du sol médiocre',
        overuseOfWaterResources: 'Surexploitation des ressources en eau',
        deforestation: 'Déforestation',
        climateChange: 'Changement climatique',
        overgrazing: 'Surpâturage',
        other: 'Autre',
        heavyRainfall: 'Pluies abondantes',
        poorDrainageSystems: 'Systèmes de drainage inefficaces',
        highWaterTable: 'Nappe phréatique élevée',
        overIrrigation: 'Sur-irrigation',
        soilCompaction: 'Compactage du sol',
        urbanization: 'Urbanisation',
        flooding: 'Inondations',
        windErosion: 'Érosion éolienne',
        waterErosion: 'Érosion hydrique',
        humanActivity: 'Activité humaine',
        gullyErosion: 'Érosion en ravines',
        sheetErosion: 'Érosion en nappe',
        rillErosion: 'Érosion en rigoles',
        agriculturalPractices: 'Pratiques agricoles',
        industrialActivities: 'Activités industrielles',
        pavingAndConcreting: 'Pavage et bétonnage',
        naturalProcesses: 'Processus naturels',
        erosion: 'Érosion',
        contamination: 'Contamination',
        lossOfNutrients: 'Perte de nutriments',
        overuseOfSoil: 'Surexploitation du sol',
        intensiveAgriculture: 'Agriculture intensive',
        soilErosion: 'Érosion du sol',
        poorLandManagement: 'Mauvaise gestion des terres',
        acidic: 'Acide',
        slightlyAcidic: 'Légèrement acide',
        neutral: 'Neutre',
        slightlyAlkaline: 'Légèrement alcalin',
        alkaline: 'Alcalin',
        notSure: 'Pas sûr',
        pollution: 'Pollution',
        naturalSoilConditions: 'Conditions naturelles du sol'
    },
    codeRepository: 'Répertoire de code',
    allRightsReserved: 'Tous droits réservés',
    shapeTheFuture: 'Façonnez l’avenir de l’éducation sur les sols.',
    togetherWeMap: 'Ensemble, nous cartographions, connectons et éduquons pour cultiver la connaissance des sols, en favorisant la sensibilisation, l’engagement et les pratiques durables.',
    exploreTheMap: 'Explorer la carte',
    learnMore: 'En savoir plus',
    aboutTheProject: 'À propos du projet',
    learnMoreAboutTheProject: 'En savoir plus sur le projet',
    mappingSoilDegradation: 'Cartographier la dégradation des sols à portée de main',
    mappingSoilDegradationDescription1: 'LOESS Soil Map est une plateforme qui rassemble la communauté dans l’effort de protéger les sols. En utilisant des cartes interactives et des outils de géolocalisation, les utilisateurs peuvent construire collectivement une base de données en ajoutant des informations sur les conditions des sols dans leurs zones locales.',
    mappingSoilDegradationDescription2: 'Les données collectées soutiennent les chercheurs et les décideurs dans la prise de décisions environnementales éclairées. Avec un formulaire d’enquête simple et une interface intuitive, tout le monde peut contribuer à une meilleure compréhension des processus de dégradation des sols et aider efficacement à les protéger.',
    sharedKnowledgeBase: 'Une base de connaissances partagée pour un avenir meilleur',
    sharedKnowledgeBaseDescription1: 'Le projet LOESS Soil Map, réalisé dans le cadre du programme international de recherche LOESS, regroupe des données sur l’érosion des sols, le pH et l’humidité, permettant une analyse globale. En conséquence, les utilisateurs ont accès à des informations complètes qu’ils peuvent mettre en pratique, allant de la recherche scientifique aux initiatives écologiques.',
    sharedKnowledgeBaseDescription2: 'Établir un écosystème de données cohérent est notre clé pour des solutions collectives. Grâce à la participation communautaire et aux technologies modernes, LOESS Soil Map devient un centre d’échange d’informations, soutenant les efforts de protection de l’environnement et préservant les intérêts des générations futures.',
    howToUseTheApp: 'Comment utiliser l’application',
    watchVideoDescription: 'Regardez la courte vidéo sur l’utilisation de l’outil de cartographie communautaire',
    appTutorial: 'Tutoriel de l’application',
    dragMarkerMessage: 'Faites glisser le marqueur temporaire vers l’emplacement souhaité',
    locationError: 'Impossible de localiser votre position, veuillez actualiser la page.',
    noPointsToApprove: 'Aucun point à approuver',
    noPointsFound: 'Aucun point trouvé',
    dateRange: 'Plage de dates',
    selectCategoryPlaceholder: 'Sélectionnez une catégorie',
    getDataReport: 'Obtenir un rapport de données',
    surveyStatusUpdated: 'Le statut de l’enquête a été mis à jour',
    oopsSomethingWentWrong: 'Oups ! Une erreur est survenue. Veuillez réessayer plus tard.',
    downloadReportFailed: 'Le téléchargement du rapport a échoué.',
    save: 'Enregistrer',
    managePermissions: 'Gérer les permissions',
    banUserTooltip: 'Bannir l’utilisateur. Cela l’empêchera d’ajouter des points sur la carte',
    usersCount: 'Nombre d’utilisateurs :',
    userPermissionsUpdated: 'Les permissions de l’utilisateur ont été mises à jour.',
    userStatusUpdated: 'Le statut de l’utilisateur a été mis à jour.',
