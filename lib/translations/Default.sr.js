...
exports.sr = {
    ...
    categoryInformationTooltip: {
        ...
        EROSION: '<b>Erodirano zemljište</b> - Proces gubitka površinskih slojeva zemljišta delovanjem jednog ili više procesa (vetra, vode, ljudskih aktivnosti…)',
        SEALED_SOILS: '<b>Zauzeto, betonirano zemljište</b> - Zauzimanje zemljišta – Proces zauzimanje/prekrivanja zemljišta zgradama ili različitim veštačkim materijalima.',
        DEGRADATION: '<b>Degradirano zemljište</b> - Degradacija zemljišta – Negativan proces koji često ubrzavaju ljudske aktivnosti (nepravilna upotreba zemljišta i prakse obrade, zbijanje zemljišta).',
        ...
        BIODIVERSITY: '<b>Gubitak biodiverziteta</b> - Proces smanjenja raznovrsnosti i brojnosti živih organizama, što dovodi do degradacije ekosistema.'
    },
    pointStatus: {
        status: 'Status',
        PENDING: 'Čeka na verifikaciju',
        ACCEPTED: 'Prihvaćeno',
        REJECTED: 'Odbijeno'
    },
    login: 'Prijavi se',
    ...
    userProfile: {
        ...
        deleteAccountPopup: {
            ...
            firstConfirmation: {
                title: 'Ukloni nalog',
                description: 'Da li ste sigurni da želite da uklonite svoj nalog? Svi vaši podaci će biti izgubljeni i neće moći da se povrate.'
            },
            secondConfirmation: {
                title: 'Da li ste sigurni da želite da uklonite svoj nalog?',
    ...
    pointManagement: {
        ...
        pointsToApprove: 'Tačke za odobrenje',
        approvedPoints: 'Odobrene tačke',
        pointId: 'ID tačke',
        pointName: 'Naziv tačke',
        dateFrom: 'Datum od',
        dateTo: 'Datum do',
        pointType: 'Tip tačke',
        approve: 'Odobri',
    ...
    userManagement: {
        ...
        confirmDeleteMessage: 'Da li ste sigurni da želite da obrišete ovaj korisnički nalog zajedno sa svim njegovim unosima?',
        cancel: 'Otkaži',
        confirm: 'Obriši nalog',
        noUsers: 'Nema korisnika za prikaz'
    },
    onboarding: {
        ...
        instruction: {
            ...
            step2: {
                ...
                description: 'Za bolji kvalitet prijave, postaraj se da navedeš sve informacije koje imaš. To će istraživačima pomoći u pokušaju da reše problem.'
            },
            step3: {
    ...
    mappingSoilDegradationDescription1: 'LOESS Soil Map je platforma koja okuplja zajednicu u nastojanju da se zaštiti tlo. Korišćenjem interaktivnih mapa i alata za geolokaciju, korisnici mogu zajednički izgraditi bazu podataka dodavanjem informacija o stanju tla u svojim lokalnim područjima.',
    mappingSoilDegradationDescription2: 'Prikupljeni podaci podržavaju istraživače i donosioce odluka u donošenju informisanih odluka o životnoj sredini. Uz jednostavan obrazac ankete i intuitivno sučelje, svako može doprineti dubljem razumevanju procesa degradacije tla i efikasno pomoći u zaštiti tla.',
    sharedKnowledgeBase: 'Zajednička baza znanja za bolju budućnost',
    sharedKnowledgeBaseDescription1: 'Projekat LOESS Soil Map, sproveden u okviru međunarodnog istraživačkog programa LOESS, prikuplja podatke o eroziji tla, pH vrednosti i vlažnosti, omogućavajući globalnu analizu. Kao rezultat, korisnici dobijaju pristup sveobuhvatnim informacijama koje mogu primeniti - od naučnih istraživanja do ekoloških inicijativa.',
    sharedKnowledgeBaseDescription2: 'Stvaranje kohezivnog ekosistema podataka je naš ključ za zajednička rešenja. Kroz uključivanje zajednice i moderne tehnologije, LOESS Soil Map postaje centralno mesto za razmenu informacija, podržava napore u zaštiti životne sredine i osigurava interese budućih generacija.',
