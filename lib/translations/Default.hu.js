...
exports.hu = {
    ...
    userProfile: {
        ...
        deleteAccountPopup: {
            ...
            firstConfirmation: {
                title: 'Fiók törlése',
                description: 'Biztosan törölni szeretnéd a fiókodat? Minden adatod el fog veszni, és nem lehet visszaállítani.'
            },
            secondConfirmation: {
    ...
    pointManagement: {
        ...
        pointsToApprove: 'Jóváhagyásra váró pontok',
        approvedPoints: 'Jóváhagyott pontok',
        pointId: 'Pont azonosító',
        pointName: 'Pont neve',
        dateFrom: 'Dátumtól',
        dateTo: 'Dátumig',
        pointType: 'Pont típusa',
        approve: 'Jóváhagyás',
        delete: 'Törlés',
    ...
    userManagement: {
        ...
        confirmDeleteMessage: 'Biztosan törölni szeretnéd ezt a felhasználói fiókot az összes bejegyzésével együtt?',
        cancel: 'Mégse',
    ...
    togetherWeMap: 'Együtt térképezünk, kapcsolódunk és tanítunk a talajok megértéséért, elősegítve a tudatosságot, az elköteleződést és a fenntartható gyakorlatokat.',
    ...
    mappingSoilDegradationDescription1: 'A LOESS Soil Map egy olyan platform, amely összefogja a közösséget a talajok védelméért. Az interaktív térképek és helymeghatározó eszközök révén a felhasználók közösen hozhatnak létre adatbázist a helyi talajállapotokról.',
    mappingSoilDegradationDescription2: 'A begyűjtött adatok segítik a kutatókat és döntéshozókat, hogy megalapozott környezeti döntéseket hozzanak. Az egyszerű kérdőívek és intuitív felület segítségével bárki hozzájárulhat a talajromlási folyamatok mélyebb megértéséhez és a talajvédelemhez.',
    sharedKnowledgeBase: 'Közös tudásbázis egy jobb jövőért',
    sharedKnowledgeBaseDescription1: 'A nemzetközi LOESS kutatási program keretében végzett LOESS Soil Map projekt összegyűjti a talajerózióról, pH-ról és nedvességről szóló adatokat, lehetővé téve a globális elemzést.',
    sharedKnowledgeBaseDescription2: 'Egy egységes adatokon alapuló ökoszisztéma megteremtése kulcsfontosságú a közös megoldásokhoz. A közösségi részvétel és a modern technológiák révén a LOESS Soil Map központi információcsere-platformmá válik.',
